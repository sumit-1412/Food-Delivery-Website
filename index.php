...
<div class="container-fluid">
  <div class="row">
	...
	<div class="container-fluid">
	 ...
	 <div class="container">
	 <p style="font-family:'sans-serif', cursive; font-weight:light;  font-size:25px;"><br>Food Hunt is an online platform that connects hungry customers with nearby restaurants and eateries, simplifying the process of ordering food. The website typically offers features such as order tracking, user reviews, and recommendations, ensuring a convenient and personalized dining experience. With the added advantage of mobile responsiveness and social media integration.</p>
	 </div>
...
<div class="container-fluid">
     <div class="row"><!--main row-->
	   ...
	   <div class="col-sm-6">
	        ...
	        <div class="container">
	        <!--paragraph content--> 
	             <p style="font-family:'sans-serif', cursive; font-weight:light; font-size:25px;"><br>Food Hunt allows for secure account creation with saved delivery addresses and payment methods, streamlining future orders. A virtual shopping cart facilitates easy order customization and review before proceeding to checkout. Customers can choose delivery or pickup options, input delivery instructions, and access various payment methods, including cards and mobile wallets. Real-time order tracking keeps users informed about the order's status, from preparation to delivery.</p>
	        </div>
	  </div>
